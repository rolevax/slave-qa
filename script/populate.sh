...
cast send $CONTRACT "sellSelf(uint256,string)" 5000000000 "我也是猫娘呐呐呐" --private-key $KEY3
cast send $CONTRACT "sellSelf(uint256,string)" 5000000000 "修图，定金10u，结算用NFT Swap，支持路人下单，主人半价" --private-key $KEY4
